...
Reviewed: 2026-06-21
<!-- Mandatory first read for ABN EA work (EA/mesh/MESH.md gate). -->
...
- [ ] Capture start date, rate/contract terms, role/title, agency/intermediary, and key contacts when available
- [ ] Track access setup and required compliance/admin steps

## Known unknowns

- Formal entity/name: ABN or ABN AMRO
- Role/title
- Start date
- Rate/contract terms
