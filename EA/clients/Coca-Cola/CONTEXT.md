...
- [ ] Wait for or review employment contract
- [ ] Capture start date, role/title, reporting line, compensation, and onboarding tasks when available
- [ ] Add key contacts when known
