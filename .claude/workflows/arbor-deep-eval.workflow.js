...
await agent(
  `Editor pass + MERGE into the existing backlog (CRITICS.md §6). The cheap lenses (bugs/language/feedback/safety) already ran this cycle and their findings are in PAI/projects/parenting-os-plugin/mesh/improvement/IMPROVEMENT-BACKLOG.md — READ it first and PRESERVE every existing finding. ` +
