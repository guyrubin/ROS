...
await agent(
  ...
  `(3) WRITE: APPEND a dated "## Clinical Excellence — <date>" section to PAI/projects/parenting-os-plugin/mesh/improvement/IMPROVEMENT-BACKLOG.md with a scored table (ID|Gap|Lens|Cited bar|riskClass|Priority|Owner pod|Required fix), then a short "Clinical authority vs market" thesis: where Arbor already leads, the 2-3 gaps that would make it best-in-market, and the one moat-native clinical bet to lead with. PRESERVE the existing file — append only. ` +
