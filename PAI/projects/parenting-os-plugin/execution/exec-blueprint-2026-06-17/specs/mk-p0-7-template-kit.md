...
**Create:**
- `PAI/projects/parenting-os-plugin/marketing/template-kit/README.md` — kit index: the four families, aspect-ratio contract, watermark rule, Canva link, how-to-fill, caption sources (→ copy pack).
- `PAI/projects/parenting-os-plugin/marketing/template-kit/BRAND.md` — the frozen brand lock (§A above): tokens extracted from the HE landing, HE vs EN type rules, swatch hexes for Canva, do/don't.
- `PAI/projects/parenting-os-plugin/marketing/template-kit/avatar-challenge.html` — 9:16 + 1:1 frame, HE+EN slots.
- `PAI/projects/parenting-os-plugin/marketing/template-kit/two-am-reel.html` — 9:16 dark-calm hook frame, HE hook slots pre-loaded.
- `PAI/projects/parenting-os-plugin/marketing/template-kit/answer-card.html` — 1:1 + 4:5, Read/Risk/Do-tonight, mirrors in-app card.
- `PAI/projects/parenting-os-plugin/marketing/template-kit/growth-card.html` — 1:1 + 9:16, monthly memory-moat beat.
- `PAI/projects/parenting-os-plugin/marketing/assets/templates/` — 8 example PNG renders (2 per family, HE+EN where relevant).

**Edit (shared file — see conflict notes):**
- `PAI/projects/parenting-os-plugin/marketing/arbor-marketing-backlog.md` — update only the P0-7 row (`:19`): mark the 4 templates done, link the kit README, and **correct the "Inter/Fraunces" note to reflect the live HE Hebrew-sans override** (Assistant/Heebo).

**Reference only (do NOT edit):**
- `PAI/projects/parenting-os-plugin/html/arbor-marketing-landing-page-he.html` (brand-token source).
- `PAI/projects/parenting-os-plugin/marketing/arbor-launch-copy-pack.md` (all overlay strings).
- `PAI/projects/parenting-os-plugin/marketing/arbor-loop-eng-spec.md` (aspect/watermark contract from P0-3).
...
7. **Verified live on dev server:** open each template HTML on the local static dev server (e.g. `npx serve PAI/projects/parenting-os-plugin/marketing/template-kit`) and confirm fonts load, RTL renders, and the frame matches the HE landing brand at the three aspect ratios.
