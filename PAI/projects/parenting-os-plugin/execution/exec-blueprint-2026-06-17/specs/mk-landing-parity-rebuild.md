...
- **EDIT (full rewrite):** `PAI/projects/parenting-os-plugin/html/arbor-marketing-landing-page-en.html`
- **EDIT (font line + optional CSS consolidation only):** `PAI/projects/parenting-os-plugin/html/arbor-marketing-landing-page-he.html`
- **Asset (already exists, no change):** `PAI/projects/parenting-os-plugin/brand/arbor-mark-transparent.png` — both pages reference it as `../brand/arbor-mark-transparent.png`; verify the path resolves from `html/`.
