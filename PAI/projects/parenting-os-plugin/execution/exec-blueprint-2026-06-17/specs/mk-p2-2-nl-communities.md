...
The primary deliverable is one markdown ops asset: `PAI/projects/parenting-os-plugin/marketing/arbor-nl-community-creator-playbook.md`. Disciplines applied: `marketing:campaign-plan` for channel sequencing + `rubin-os:copywriter` for the NL/EN outreach scripts. It MUST contain the following sections, fully written (no placeholders, no "[TBD]").
