...
### Problem / why
`PAI/projects/parenting-os-plugin/html/arbor-marketing-landing-page.html` (no language suffix) is a **stale duplicate of the Hebrew landing page**. Confirmed on disk:
...
1. **Delete the stale file** `PAI/projects/parenting-os-plugin/html/arbor-marketing-landing-page.html` using `git rm` (so the deletion is staged for the tracked file, not just an unlink).
2. **Verify no live link/canonical/hreflang points at the deleted filename.** Confirmed during grounding:
   ...
   - The only repo references to `arbor-marketing-landing-page.html` are **prose mentions in docs**, not links:
     - `PAI/projects/parenting-os-plugin/PRODUCT.md:25` — describes "the older `arbor-marketing-landing-page.html` lane" as generic/drifting.
     - `PAI/projects/parenting-os-plugin/execution/arbor-surface-coordination-2026-05-24.md:31,70,77` — flags it as non-canonical and explicitly lists "delete it" as an option.
...
- **Delete:** `PAI/projects/parenting-os-plugin/html/arbor-marketing-landing-page.html`
- **Edit:** `PAI/projects/parenting-os-plugin/PRODUCT.md` (line ~25 — drop the live filename, mark lane deleted)
- **Edit:** `PAI/projects/parenting-os-plugin/execution/arbor-surface-coordination-2026-05-24.md` (append resolution note to the existing non-canonical-file item)
- **Keep untouched:** `PAI/projects/parenting-os-plugin/html/arbor-marketing-landing-page-he.html` (canonical HE), `arbor-marketing-landing-page-en.html` (canonical EN), `arbor-landing.html` (separate earlier marketing concept — out of scope, do **not** delete).
