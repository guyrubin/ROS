...
| ROS `PAI/projects/parenting-os-plugin/` | Product strategy and durable memory | PRD, safety policy, roadmap, scenario library, execution notes | Coordination layer; PRD in `app/docs/arbor-prd.md` is the living engineering PRD |
...
- `PAI/projects/parenting-os-plugin/html/arbor-marketing-landing-page.html` was inspected. It is Arbor-branded and directionally aligned with private-beta positioning, but remains untracked/non-canonical until reviewed and committed.
