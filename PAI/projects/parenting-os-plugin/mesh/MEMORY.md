...
**Artifact:** `PAI/projects/parenting-os-plugin/execution/mobile-store/M3-listing-metadata.md`
...
**Audit output:** `PAI/projects/parenting-os-plugin/execution/mobile-store/M1-store-readiness-audit.md`
...
`PAI/projects/parenting-os-plugin/html/arbor-il.html`
...
`PAI/projects/parenting-os-plugin/marketing/arbor-2am-test-he/compositions/main-graphics.html`
...
**Output:** `PAI/projects/parenting-os-plugin/marketing/assets/launch/he-qa-and-pricing.md`
...
**Three assets produced to `PAI/projects/parenting-os-plugin/marketing/assets/launch/`:**
...
**Hook bank created:** `PAI/projects/parenting-os-plugin/mesh/marketing/hook-bank.md` — 8 IL launch entries seeded; performance column empty pending first postings.
...
| :-- | :-- | :-- |
| `PAI/projects/parenting-os-plugin/html/arbor-il.html` | `arborprd-westeu.web.app` | canonical→`/he/`, hreflang, og:url, og:image→1200×630 PNG, JSON-LD @ids, schema availability PreOrder→OnlineOnly, all body CTAs |
| `PAI/projects/parenting-os-plugin/html/arbor-marketing-landing-page-he.html` | `arborprd-westeu.web.app` | canonical→`/he/`, hreflang, og:url, og:image→1200×630 PNG, og:title→native HE one-liner, og:locale he_IL added, JSON-LD @ids+availability+dateModified, all body CTAs. Frank Ruhl Libre import confirmed present (line 111). |
| `PAI/projects/parenting-os-plugin/html/arbor-marketing-landing-page-en.html` | `arborprd-westeu.web.app` | canonical→`/en/`, hreflang, og:url, og:image→1200×630 PNG, og:title→brand one-liner, JSON-LD @ids+availability+dateModified, all body CTAs |
| `PAI/projects/parenting-os-plugin/marketing/assets/arbor-is-this-normal-he.html` | `arbor.family` (all 30+ refs) | canonical, hreflang, og:url, og:image, twitter:image, JSON-LD @ids, nav/footer/CTA links |
