...
**Raw notes:** land in `PAI/projects/arbor/research/interviews/YYYY-MM-DD_{slug}.md` (create the folder on first use). Never publish verbatim quotes under a parent's name externally; internal use only.
...
File location: `PAI/projects/arbor/research/vop-pulse/YYYY-WW.md`
