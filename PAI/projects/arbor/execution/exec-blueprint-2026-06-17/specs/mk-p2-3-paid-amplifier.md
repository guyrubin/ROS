...
> Build-ready spec. Source plan: `PAI/projects/arbor/marketing/arbor-viral-gtm-2026-H2.md` (§3, §6, §8, §9). Backlog row: P2-3. Loop eng spec: `PAI/projects/arbor/marketing/arbor-loop-eng-spec.md`.
...
Create:
- `PAI/projects/arbor/marketing/arbor-paid-amplifier-runbook.md` — gate + budget + UTM contract + kill/double + spend-log template.

Edit:
- `PAI/projects/arbor/marketing/arbor-viral-gtm-2026-H2.md` — §6: add the explicit spend-gate preconditions + the 70/30 boost/retarget split + UK/IE phase weighting note pointing to the runbook. (This is the declared `sharedFiles` entry for this item.)
- `PAI/projects/arbor/html/arbor-marketing-landing-page-en.html` — replace dead final CTA (`:286`); unify CTA hrefs (`:147`, `:158`, `:286`) to the canonical install URL; add the ~15-line UTM-passthrough inline script.
- `PAI/projects/arbor/marketing/EXECUTION-TRACKER.md` — flip P2-3 status and link the runbook.
