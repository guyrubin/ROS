...
### Parenting App / Arbor
- Status: Active | Phase: Roadmap / Phase 0
- Positioning: Developmental operating system for modern families
- Current artifact: `PAI/projects/parenting-os-plugin/roadmap.md`
- Next: Create PRD v1, data model v1, safety policy v1, scenario library v1, and Netherlands GTM v1
